...
<div class="container" {id}>
  ...
  <div class="row">
    <p>
      ...
      _______________ _______________ _______________ _______________ _______________ (_______________ _______________), _______________ № _______________, именуемый в дальнейшем «Исполнитель», с
      ...
      >
        <tbody>
          <tr>
            ...
            <td>
              <span class="fw-bold">Исполнитель</span><br />_______________ _______________
              _______________ <br />ИНН _______________
            </td>
          </tr>
          <tr>
            <td>
            ...
            >
            <td>
              Адрес: _______________ _______________, _______________, _______________
          ...
          <tr>
            ...
            <td>
              Номер телефона: _______________<br />Мессенджер:
              _______________ _______________<br />Эл. почта:
              _______________
            </td>
          </tr>
        </tbody>
