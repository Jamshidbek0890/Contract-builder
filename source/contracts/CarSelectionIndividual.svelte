...
<div class="container" {id}>
  ...
  <div class="row">
    <p>
      ...
      одной стороны и Физическое лицо {#if $fullName.name && $fullName.surname && $fullName.fatherhood}{$fullName.surname}
        {$fullName.name}
        {$fullName.fatherhood}{:else}<Empty />{/if}, паспорт {#if $passport}{$passport}{:else}<Empty
        />{/if}, проживающий по адресу: {#if $address}{$address}{:else}<Empty
        />{/if}, именуемый в дальнейшем «Заказчик» с другой стороны, заключили
      ...
      >
        <tbody>
          <tr>
            ...
            <td>
              <span class="fw-bold">Исполнитель</span><br />_______________
              _______________ _______________ _______________ <br />ИНН
              _______________
            </td>
          </tr>
          <tr>
            ...
            >
            <td>
              Адрес: _______________ _______________, _______________,
          ...
          <tr>
            ...
            <td>
              Номер телефона: _______________<br />Мессенджер: _______________
              _______________<br />Эл. почта: _______________
            </td>
          </tr>
        </tbody>
      </table>
